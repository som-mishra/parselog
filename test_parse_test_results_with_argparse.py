...
class TestParseTestResults(unittest.TestCase):
	...
	def test_validate_inputs1(self):
	 	...
	 	self.assertEqual(expected, parse_test_results_with_argparse.validate_inputs(date1, time1))
	...
	def test_validate_inputs5(self):
	 	date1 = "2000-11"
	 	time1 = "23:34:12.123"
	 	expected = ("2000-11-01", "23:34:12.123")
	 	self.assertEqual(expected, parse_test_results_with_argparse.validate_inputs(date1, time1))
	...
	def test_validate_inputs6(self):
	 	date1 = "2000"
	 	time1 = "23:34:12.123"
	 	expected = ("2000-01-01", "23:34:12.123")
	 	self.assertEqual(expected, parse_test_results_with_argparse.validate_inputs(date1, time1))
